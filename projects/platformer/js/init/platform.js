(function (window) {
    ...
    platform.init = function (game) {
        ...
        // example:
        platform.create(400, 460);//Given
        platform.create(500, 200);//Given
        platform.create(120,325);//User Created
        platform.create(50,570);//User Creaetd
        platform.create(300,400);//User Created       
