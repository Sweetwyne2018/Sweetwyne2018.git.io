(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.steve, 200, 170, 6, 0.7);//Given
        collectable.create(type.steve, 400, 90, 6, 0.7);//User Created
        collectable.create(type.steve, 600, 40, 6, 0.7);//User Created
